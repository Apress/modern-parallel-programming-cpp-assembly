...
void MatrixVecMulF32_bm(void)
{
    ...
    for (size_t i = 0; i < num_it; i++)
    {
        ...
        bmtt.Start(i, 1);
        MatVecMulF32a_Aavx512(vec_b2, m.Data(), vec_a, num_vec);
        bmtt.Stop(i, 1);

        bmtt.Start(i, 2);
        MatVecMulF32b_Aavx512(vec_b3, m.Data(), vec_a, num_vec);
        bmtt.Stop(i, 2);
    }

    std::string fn = bmtt.BuildCsvFilenameString("Ch18_05_MatrixVecMulF32_bm");
