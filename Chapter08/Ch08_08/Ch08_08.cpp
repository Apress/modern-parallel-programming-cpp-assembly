...
int main()
{
    ...
    {
        std::cout << "Ch08_08 exception: " << ex.what() << '\n';
    }
...
static void Convolve1D_F32(void)
{
    ...
    const char* bn_results = "Ch08_08_Convolve1D_F32_Results";
    const std::vector<float> kernel { 0.0625f, 0.25f, 0.375f, 0.25f, 0.0625f };

    // Create input and output signal arraysy
    ...
    Convolve1D_F32_Iavx512(y2, x, kernel);
    Convolve1DKs5_F32_Iavx512(y3, x, kernel);
